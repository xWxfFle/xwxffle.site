    ...
    <div className="mx-auto flex w-full flex-col flex-wrap items-start justify-center bg-base-200 md:flex-row">
      <div className="h-full w-full p-6 text-xl md:my-12 md:mb-40 lg:w-2/6">
        ...
        <p className="mb-8  leading-normal">
          ...
          year of commercial experience. I started my career in 2021 as a
          trainee <span className="text-info">Node.js</span> developer for a
          company working on blockchain apps. After realizing my interest was
          mostly in frontend development, I shifted my focus and began mastering{' '}
          ...
          <span className="text-info">Three.js</span> and{' '}
          <span className="text-info">React Three Fiber</span>. Also, I like to
